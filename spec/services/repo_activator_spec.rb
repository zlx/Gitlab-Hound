  ...
  describe '#activate' do
    context 'when repo activation succeeds' do
      it 'activates repo' do
        ...
        expect(activator.activate(repo)).to be_truthy
      ...
      it 'returns true if the repo activates successfully' do
        ...
        response = activator.activate(repo)
    ...
    context 'when repo activation fails' do
      ...
      context 'when Hound cannot be added to repo' do
        it 'returns false' do
          ...
          expect(activator.activate(repo)).to be_falsy
        end
      end
    end
    ...
    context 'hook already exists' do
      it 'does not raise' do
        ...
        expect { activator.activate(repo) }.not_to raise_error
  ...
  describe '#deactivate' do
    context 'when repo activation succeeds' do
      ...
      it 'returns true if the repo activates successfully' do
        ...
        response = activator.deactivate(membership.repo)
